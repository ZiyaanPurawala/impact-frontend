...
export default function Register() {
  ...
  const [form, setForm] = useState({ name: '', email: '', password: '', phoneNumber: '', unitPreference: 'kg' });
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    const result = await register(form.name, form.email, form.password, form.unitPreference, form.phoneNumber);
    setLoading(false);
      ...
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input type="tel" className="form-input" placeholder="e.g. +1234567890"
